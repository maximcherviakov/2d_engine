...
int main(int argc, char** argv)
{
    ...
    {
        ResourceManager resousceManager(argv[0]);
        auto pDefaultShaderProgram = resousceManager.loadShader("DefaultShader", "res/shaders/vertex_shader.txt", "res/shaders/fragment_shader.txt");
